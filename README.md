...
-Organización en 3 bloques principales (cada bloque responde a una tarea independiente):
1. Mover objetos aleatoriamente
   - Esta sección posee campos de parametros para rellenar.
3. Renombrar objetos
5. Origen del objeto -> Origen del mundo
